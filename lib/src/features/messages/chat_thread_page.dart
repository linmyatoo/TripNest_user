        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                title: const Text('Celebration Concert', style: TextStyle(fontWeight: FontWeight.w700)),
          ...
          Expanded(
            child: ListView(
              ...
              children: const [
                _Bubble.mine('Hi Panda, Let’s meet at the event.\nSee you mateeeee!', '8:12 Am'),
...
class _Bubble extends StatelessWidget {
  const _Bubble.mine(this.text, this.time)
      : mine = true;
  const _Bubble.theirs(this.text, this.time)
      : mine = false;
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          ...
          Text(time, style: TextStyle(color: textColor.withOpacity(.8), fontSize: 11)),
        ]),
      ),
    );
  }

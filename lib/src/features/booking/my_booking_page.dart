...
class _MyBookingPageState extends State<MyBookingPage> {
  ...
  Widget _pill({required bool selected, required String label, VoidCallback? onTap}) {
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text(day, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700)),
              const SizedBox(height: 4),
              Text(mon, style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
            ]),
          ),
          ...
          ClipRRect(
            borderRadius: BorderRadius.circular(12),
            child: Image.network(event.imageUrl, width: 88, height: 66, fit: BoxFit.cover),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 4),
              Text(event.shortLocation, style: const TextStyle(color: AppColors.textSecondary)),
            ]),
          ),
